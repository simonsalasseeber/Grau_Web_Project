...
const DownNav = () => {
  ...
  <div className="flex flex-col items-center md:items-start mb-4 md:mb-0 text-xs md:text-base">
    <a href="https://www.instagram.com/justgrau_/?hl=es" target="_blank" rel="noopener noreferrer" className="text-[#E0DECD] no-underline">
      <p className="mb-1 md:mb-0">ig @justgrau_</p>
    </a>
